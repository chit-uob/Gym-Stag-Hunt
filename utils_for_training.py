...
def eval_agent(env, human_agent, rl_agent, time_step=20, eval_type='turn_until_reward'):
    """
    ...
    :param time_step: The number of time steps to evaluate the agent for.
...
def reset_env(env):
    env.reset()
    # todo: need to reconstruct env to reset logic
    # either I recreate the env every time
    # or I have to use inheritance to reset certain behaviors


def train_agent(env, human_agent_settings, rl_agent,
                episodes=5000, time_step=20, progress_print=500,
